...
--
-- Table structure for table `hospitales22`
--

DROP TABLE IF EXISTS `hospitales22`;
...
--
-- Dumping data for table `hospitales22`
--

LOCK TABLES `hospitales22` WRITE;
/*!40000 ALTER TABLE `hospitales22` DISABLE KEYS */;
/*!40000 ALTER TABLE `hospitales22` ENABLE KEYS */;
UNLOCK TABLES;
